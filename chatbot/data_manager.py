"""Data Manager for HMAWBI University Chatbot modifications to include university news management capabilities"""
...
from .data.student_engagement import FUNNY_JOKES, PERSONAL_ENCOURAGEMENT, FUN_FACTS, add_joke, add_encouragement, add_fun_fact, add_university_news, search_news, get_news_by_category, UNIVERSITY_NEWS
...
class DataManager:
    ...
    def add_news(self, title: str, content: str, category: str = "general", tags: List[str] = None) -> bool:
        """Add university news"""
        return add_university_news(title, content, category, tags or [])
